...
vim.keymap.set('n', '<leader>tt', function()
  require('custom.theme').toggle()
end, { desc = '[T]oggle light/dark [T]heme' })
...
vim.keymap.set('n', '<leader>ot', function()
  ...
  local vault = vim.fn.expand '/mnt/c/Users/SchollJ/Documents/notes/obsidian/' -- change this
  vim.cmd 'new'
  vim.fn.termopen("rg -e '- \\[ \\].*" .. date .. "' " .. vault .. ' --no-heading --no-filename --no-line-number')
end, { desc = 'Obsidian tasks due today' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<C-p>', builtin.git_files, { desc = '[S]earch Git [P]roject' })
  ...
  { -- You can easily change to a different colorscheme.
    ...
    config = function()
      ...
      -- Apply theme from shared state file (~/.config/theme); toggle with <leader>tt
